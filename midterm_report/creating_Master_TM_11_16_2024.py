...
casinoSpec = pd.concat([Treated, Control], ignore_index=True)
print(casinoSpec.columns)
casinoSpec.to_csv('removeme2.csv', index=False)
...
# CasinoSpec_byYear = casinoSpec.merge(decadeSt,how='cross')
# CasinoSpec_byYear.to_csv('removeme11.csv', index=False)
...
Master_set_09_28_24.to_csv('Master_set_11_18_24.csv', index=False)